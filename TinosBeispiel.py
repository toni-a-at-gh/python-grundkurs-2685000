...
# "pyproject.toml" benutzen. Die Notizen aus dem Branch "05_03-Setup-py-und-PIP" wurden hierher
...
#
#
# Projekt konfigurieren mittels 'pyproject.toml':
# ===============================================
#
# Die Konfiguration mittels 'pyproject.toml' stellt eine moderne Variante dar im Vergleich
# zu "Projekt konfigurieren mittels 'setup.py'". Der Unterschied:
#
#   - Es gibt nur eine Konfigurationsdatei 'pyproject.toml' statt zwei ('setup.py' und 'requirements.txt')
#
# Die Installation erfolgt auch mittels "pip install".
